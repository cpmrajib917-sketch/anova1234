  ...
  return (
    ...
    >
      ...
      <div className="p-2 md:p-3 relative z-10 flex flex-col justify-between flex-1">
        ...
        <div className="flex items-center gap-1.5 mt-1.5 text-[9px] md:text-[10px] text-gray-400 font-medium truncate">
          {anime.status && (
            <>
              <span className={cn(
                "w-1 md:w-1.5 h-1 md:h-1.5 rounded-full shrink-0", 
